...
def test_group_intervals():
  ...
  intervals = [
    Interval('1', 10, 100), Interval('1', 90, 150), Interval('1', 200, 250)
  ]
  ...
  intervals = [
    Interval('X', 10, 100), Interval('Y', 90, 150), Interval('Y', 200, 250)
  ]
...
def test_merge_intervals():
  ...
  intervals = [
    Interval('1', 505, 585), Interval('1', 520, 550), Interval('1', 545, 580)
  ]
  assert merge_intervals(intervals) == (505, 585)

  # test with 1 interval
  assert merge_intervals([Interval('1', 10, 10)]) == (10, 10)
...
def test_process_interval_group():
  ...
  interval_group = [
    Interval('chr1', 1, 5), Interval('chr1', 10, 13)
  ]
